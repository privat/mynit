...
class ModelIndex
	...
	fun find_by_similarity(name: String): IndexMatches do
		var results = new IndexMatches
		results.add_all find_by_full_name_similarity(name)
		results.add_all find_by_name_similarity(name)
		return results
	end
	...
	fun find(name: String): IndexMatches do
		var results = find_by_name_prefix(name)
		results.add_all find_by_full_name_prefix(name)
		results.add_all find_by_similarity(name)
		return results
	end
end
